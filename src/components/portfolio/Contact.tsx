...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 relative" ref={ref as React.RefObject<HTMLElement>}>
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className={`max-w-2xl mx-auto text-center transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className={`flex flex-wrap gap-4 justify-center transition-all duration-700 delay-[400ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <a
